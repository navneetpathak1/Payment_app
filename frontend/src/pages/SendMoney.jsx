            ...
            >
                ...
                <div className="p-6 pt-0">
                    <div className="flex items-center space-x-4">
                        <div className="w-12 h-12 rounded-full bg-[#292075] flex items-center justify-center">
                    ...
                    <div className="space-y-4">
                        ...
                        }} className="justify-center rounded-md text-sm font-medium ring-offset-background transition-colors h-10 px-4 py-2 w-full bg-[#292075] hover:bg-[#211a5e] text-white">
                            Initiate Transfer
                        </button>
                    </div>
                </div>
